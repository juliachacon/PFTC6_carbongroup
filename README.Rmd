...
- Connect soil temperature sensor to the logger.
...
Air temperature, soil temperature, and PAR values will be logged directly in the same dataset as the cflux.
...
Turn off the fan and pump.
Disconnect both cables from the old battery.
Connect the new battery (Connect the correct colors or walk down the mountain to fetch the other licor!)
Turn on the fan and pump and check that everything works normally.
Wait a minute before starting a new measurement.
...
Connect the logger
Check the logger's clock again
Arm the logger
